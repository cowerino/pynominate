"""
Script para runnear `update_nominate` con un payload de prueba.
Este script carga un payload desde un archivo JSON, lo convierte a las estructuras necesarias 
y ejecuta la función `update_nominate`.
Utiliza datos de la base de datos del proyecto
"""
